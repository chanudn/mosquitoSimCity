...
def plot_violinplt_FocksVsEisen(df_in_Focks, df_in_Eisen, loc, fileName):
    dir_out = '/home/local/WIN/cyasana1/Code/project_whatchem/whatchem-2.1_CNY/5_plotting/'  # TEMPORARY!
...
def plot_scatter_crosstabs_FocksVsEisen(df_in_Focks, df_in_Eisen, loc, tercileName_modelVar, tercileName_den, fileName):
    dir_out = '/home/local/WIN/cyasana1/Code/project_whatchem/whatchem-2.1_CNY/5_plotting/'  # TEMPORARY!
...
if False:
    ...
    # load model pipeline data at location of interest
    # also: convert from daily to monthly
    df_vectorPop_dly_Jaffna = get_df_vectorPop_dly_merged(dataSrc, 'Jaffna', years, months, intv, initDays, initEggs, initLarvae, initPupae, survCurve)
    df_vectorPop_monthly_Jaffna = convert_df_vectorPop_dly2mon(df_vectorPop_dly_Jaffna)
    df_vectorPop_dly_Negombo = get_df_vectorPop_dly_merged(dataSrc, 'Negombo', years, months, intv, initDays, initEggs, initLarvae, initPupae, survCurve)
    df_vectorPop_monthly_Negombo = convert_df_vectorPop_dly2mon(df_vectorPop_dly_Negombo)
    df_vectorPop_dly_NuwaraEliya = get_df_vectorPop_dly_merged(dataSrc, 'NuwaraEliya', years, months, intv, initDays, initEggs, initLarvae, initPupae, survCurve)
    ...
    for loc in locs:
        ...
        for dengueDataYrs_noOutbreaks in dengueDataYrs_noOutbreaks_opts:
            ...
            if dengueDataYrs_noOutbreaks_opts: # only do this if we're restricting years to no outbreak dengue data years (2007-2020 minus 2017 and 2019)
                ...
                fName = 'violinplot_' + 'allVars' + '_' + loc + fileStr_dengueDataYrs_noOutbreaks
                plot_violinplt_FocksVsEisen(df_vectorPop_denInc_monthly_yrFiltered_Focks, df_vectorPop_denInc_monthly_yrFiltered_Eisen, loc, fName)
        ...
        for loc in locs:
            ...
            for i_lag, lagTime in enumerate(lagTimes):
                ...
                for noOutbreaks in noOutbreaks_opts:
                    ...
                    fileName_in = 'crosstab_tercile_splitbyMon_' + tercileStr_modelVar + '-' + tercileStr_den + '_' + den_pltName + '_' + loc + fileStr_noOutbreaks + fileStr_survCurve
            ...
            fileName_out = 'crosstab_tercile_splitbyMon_' + tercileStr_modelVar + '-' + tercileStr_den + '_' + den_colName_base + '_' + loc + fileStr_survCurve + '_norm'
        ...
        for loc in locs:
            ...
            for i_lag, lagTime in enumerate(lagTimes):
                ...
                for noOutbreaks in noOutbreaks_opts:
                    ...
                    filePath_norm_Eisen = DIR_WHATCHEM_OUTPUT_DATA_PROCESSED + dir_crosstabs + fileName_in_Eisen + '_norm.csv'
                    ...
                    filePath_norm_Focks = DIR_WHATCHEM_OUTPUT_DATA_PROCESSED + dir_crosstabs + fileName_in_Focks + '_norm.csv'
            ...
            plot_scatter_crosstabs_FocksVsEisen(df_crosstab_elt_norm_Focks, df_crosstab_elt_norm_Eisen, loc, tercileName_modelVar, tercileName_den, fileName_out)
